...
/// @title DeployCorridor — deploys a VEIL Corridor consumer for the Sepolia backbone.
...
contract DeployCorridor is Script {
    function run() external {
        ...
        Veil engine = Veil(vm.envAddress("ENGINE_ADDRESS"));
        bytes32 mandateId = vm.envOr("MANDATE_ID", keccak256("veil-sepolia-corridor-v1"));
        ...
        console.log("== VEIL Corridor deployed ==");
